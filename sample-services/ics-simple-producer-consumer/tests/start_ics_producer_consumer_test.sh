...
docker build -t o-ran-sc/nonrtric-sample-simple-icsproducer:0.0.1 ../kafka-producer/
docker build -t o-ran-sc/nonrtric-sample-simple-icsconsumer:0.0.1 ../kafka-consumer/
