...
#wait_for_container "informationcoordinatorservice" "Started Application in"
#wait_for_container "kafka-producer" "Started Application in"
...
space
echo "Red Panda Console: "
echo "http://localhost:8888"
echo "Done."
#docker-compose -f ../../nonrtric-controlpanel/docker-compose/docker-compose.yaml                -f ../../nonrtric-controlpanel/docker-compose/control-panel/docker-compose.yaml                -f ../../nonrtric-controlpanel/docker-compose/nonrtric-gateway/docker-compose.yaml up -d