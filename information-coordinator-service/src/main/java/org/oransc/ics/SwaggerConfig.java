...
@OpenAPIDefinition( //
        info = @Info(title = SwaggerConfig.API_TITLE, //
                ...
                license = @License(name = "Copyright (C) 2020-2022 Nordix Foundation. Licensed under the Apache License.", url = "http://www.apache.org/licenses/LICENSE-2.0")))
public class SwaggerConfig {
    ...
    static final String DESCRIPTION = "<h1>API documentation</h1>" //
            ...
            + "   <li>Filtering information (scope, filter or other discriminators).</li>"
            + "   <li>Periodicy</li>"
            + "   <li>Other info used for aggregation</li>"
            + "   <ul>" //
            + "</p>" //
