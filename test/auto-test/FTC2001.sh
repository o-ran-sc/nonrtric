...
DOCKER_INCLUDED_IMAGES="CBS CONSUL CP CR MR PMS RICSIM ICS PRODSTUB HTTPPROXY NGW KUBEPROXY"

#App names to include in the test when running kubernetes, space separated list
KUBE_INCLUDED_IMAGES=" MR CR PMS PRODSTUB RICSIM CP ICS HTTPPROXY KUBEPROXY NGW"
