...
#start_http_proxy  #Remove the comment on this line as well as two line further below to run with proxy
...
start_sdnc    # Comment out this line to run PMS with proxy
