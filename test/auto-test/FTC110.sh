...
pms_api_put_service 201 "service1" 15 "$CR_SERVICE_APP_PATH_0/service1"

pms_api_get_services 200 "service1" "service1" 15 "$CR_SERVICE_APP_PATH_0/service1"

pms_api_put_service 201 "service2" 120 "$CR_SERVICE_APP_PATH_0/service2"

pms_api_get_services 200 "service2" "service2" 120 "$CR_SERVICE_APP_PATH_0/service2"

pms_api_put_service 200 "service1" 50 "$CR_SERVICE_APP_PATH_0/service1"
pms_api_put_service 200 "service2" 180 "$CR_SERVICE_APP_PATH_0/service2"

pms_api_get_services 200 "service1" "service1" 50 "$CR_SERVICE_APP_PATH_0/service1"
pms_api_get_services 200 "service2" "service2" 180 "$CR_SERVICE_APP_PATH_0/service2"

pms_api_get_service_ids 200 "service1" "service2"
...
pms_api_get_services 404 "service1"
pms_api_get_services 404 "service2"

pms_api_put_service 201 "service3" 60 "$CR_SERVICE_APP_PATH_0/service3"

pms_api_get_services 200 "service3" "service3" 60 "$CR_SERVICE_APP_PATH_0/service3"

sleep_wait 30 "Waiting for keep alive timeout"

pms_api_put_service 200 "service3" 60 "$CR_SERVICE_APP_PATH_0/service3"

sleep_wait 100 "Waiting for keep alive timeout"

pms_api_get_services 404 "service3"

pms_api_put_service 201 "service4" 120 "$CR_SERVICE_APP_PATH_0/service4"

sleep_wait 60 "Waiting for keep alive timeout"

pms_api_get_services 200 "service4" "service4" 120 "$CR_SERVICE_APP_PATH_0/service4"

pms_api_put_services_keepalive 200 "service4"

sleep_wait 90 "Waiting for keep alive timeout"

pms_api_get_services 200 "service4" "service4" 120 "$CR_SERVICE_APP_PATH_0/service4"

pms_api_delete_services 204 "service4"

pms_api_get_services 404 "service4"

pms_api_get_services 404 "service1"
pms_api_get_services 404 "service2"
pms_api_get_services 404 "service3"

pms_api_get_service_ids 200

pms_api_delete_services 404 "service1"
pms_api_delete_services 404 "service2"
pms_api_delete_services 404 "service3"
pms_api_delete_services 404 "service4"

pms_api_put_services_keepalive 404 "service1"
pms_api_put_services_keepalive 404 "service2"
pms_api_put_services_keepalive 404 "service3"
pms_api_put_services_keepalive 404 "service4"

# Policy delete after timeout
pms_api_put_service 201 "service10" 600 "$CR_SERVICE_APP_PATH_0/service10"
...
pms_api_put_policy 201 "service10" ricsim_g1_1 1 5001 true $notificationurl testdata/OSC/pi1_template.json
pms_api_put_policy 201 "service10" ricsim_g2_1 NOTYPE 5101 true $notificationurl testdata/STD/pi1_template.json

if [ "$PMS_VERSION" == "V2" ]; then
    pms_api_put_policy 201 "service10" ricsim_g3_1 STD_QOS2_0.1.0 5201 true $notificationurl testdata/STD2/pi_qos2_template.json
    pms_equal json:policies 6
else
...
if [ "$PMS_VERSION" == "V2" ]; then
    pms_equal json:policies 3 180
else
    pms_equal json:policies 2 180
fi
...
pms_api_put_service 200 "service10" 10 "$CR_SERVICE_APP_PATH_0/service10"

#Wait for service expiry
pms_equal json:policies 0 120
