...
SUPPORTED_PROFILES="ORAN-I-RELEASE ORAN-J-RELEASE ORAN-K-RELEASE ORAN-L-RELEASE ORAN-M-RELEASE ONAP-MONTREAL ONAP-NEWDELHI ONAP-OSLO ONAP-PARIS ONAP-QUEBEC"
#Supported run modes
