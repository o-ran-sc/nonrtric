...
PMS_IMAGE_TAG_LOCAL="1.1.2-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE_SNAPSHOT="1.1.2-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE="1.1.2-STAGING-latest" #Will use snapshot repo
PMS_IMAGE_TAG_REMOTE_RELEASE="1.1.1"
