...
#  ============LICENSE_END=================================================
#
#Profile for ONAP OSLO release
TEST_ENV_PROFILE="ONAP-OSLO"
FLAVOUR="ONAP"
...
A1PMS_IMAGE_TAG_LOCAL="2.0.1-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE_SNAPSHOT="2.0.1-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE="2.0.1-STAGING-latest" #Will use snapshot repo
