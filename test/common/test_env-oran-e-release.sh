...
PMS_IMAGE_BASE="o-ran-sc/nonrtric-a1-policy-management-service"
PMS_IMAGE_TAG_LOCAL="2.3.1-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE_SNAPSHOT="2.3.1-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE="2.3.1"
PMS_IMAGE_TAG_REMOTE_RELEASE="2.3.1"
...
PROJECT_IMAGES_APP_NAMES="PMS ICS CP RC RICSIM NGW DMAAPADP DMAAPMED HELMMANAGER"  # Add SDNC here if oran image is used
...
PMS_PKG_NAME="org.onap.ccsdk.oran.a1policymanagementservice"  # Java base package name
