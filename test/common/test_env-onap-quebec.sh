...
A1PMS_IMAGE_TAG_LOCAL="2.3.0-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE_SNAPSHOT="2.3.0-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE="2.3.0-SNAPSHOT-latest" #Will use snapshot repo
A1PMS_IMAGE_TAG_REMOTE_RELEASE="2.2.0"   #quebec release
...
SDNC_A1_CONTROLLER_IMAGE_TAG_REMOTE_RELEASE="3.2.1"
