...
PMS_IMAGE_TAG_LOCAL="2.2.1-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE_SNAPSHOT="2.2.1-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE="2.2.1"
PMS_IMAGE_TAG_REMOTE_RELEASE="2.2.1"
...
PROJECT_IMAGES_APP_NAMES="PMS ICS CP RC RICSIM NGW"  # Add SDNC here if oran image is used
