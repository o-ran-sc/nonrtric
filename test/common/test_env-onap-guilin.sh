...
PMS_IMAGE_TAG_LOCAL="1.0.2-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE_SNAPSHOT="1.0.2-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE="1.0.2-SNAPSHOT" #Will use snapshot repo
PMS_IMAGE_TAG_REMOTE_RELEASE="1.0.2"
...
PROJECT_IMAGES_APP_NAMES="PMS SDNC"
...
PMS_APIS="V1"                                            # Supported northbound api versions
...
PMS_ALIVE_URL="/status"                                  # Base path for alive check
