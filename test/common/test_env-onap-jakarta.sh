...
PMS_IMAGE_TAG_LOCAL="1.3.0-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE_SNAPSHOT="1.3.0-SNAPSHOT"
PMS_IMAGE_TAG_REMOTE="1.3.0-STAGING-latest" #Will use snapshot repo
PMS_IMAGE_TAG_REMOTE_RELEASE="1.3.0"
