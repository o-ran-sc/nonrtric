...
A1PMS_IMAGE_TAG_LOCAL="2.3.2-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE_SNAPSHOT="2.3.2-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE="2.3.2-SNAPSHOT-latest" #Will use snapshot repo
A1PMS_IMAGE_TAG_REMOTE_RELEASE="2.3.1"   #rabat release
