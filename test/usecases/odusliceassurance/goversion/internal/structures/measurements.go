...
func (pr *PolicyRatio) GetUpdateDedicatedRatioMessage(sd int, sst int, dedicatedRatio int) messages.RRMPolicies {
	...
	return messages.RRMPolicies{
		RRMPolicyRatio: rrmPolicies,
	}
}
