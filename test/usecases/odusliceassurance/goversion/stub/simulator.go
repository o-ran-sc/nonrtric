...
func main() {
	...
	go func() {
		portSdnr := flag.Int("sdnr_port", 3904, "The port this SDNR stub will listen on")
		flag.Parse()
	...
	go func() {
		portDmaapMR := flag.Int("dmaap_port", 3905, "The port this message router will listen on")
		flag.Parse()
