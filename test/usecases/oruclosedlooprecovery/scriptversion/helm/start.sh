...
cd ${SHELL_FOLDER}
helm uninstall dmaap-mr message-generator oru-app sdnr-simulator
...
helm package .
helm install dmaap-mr dmaap-mr-0.1.0.tgz --namespace nonrtric --create-namespace

# build dmapp-mr helm chart & install chart
cd ${SHELL_FOLDER}/message-generator/
helm package .
helm install message-generator message-generator-0.1.0.tgz --namespace nonrtric --create-namespace

# build dmapp-mr helm chart & install chart
cd ${SHELL_FOLDER}/oru-app/
helm package .
helm install oru-app oru-app-0.1.0.tgz --namespace nonrtric --create-namespace

# build dmapp-mr helm chart & install chart
cd ${SHELL_FOLDER}/sdnr-simulator/
helm package .
helm install sdnr-simulator sdnr-simulator-0.1.0.tgz --namespace nonrtric --create-namespace