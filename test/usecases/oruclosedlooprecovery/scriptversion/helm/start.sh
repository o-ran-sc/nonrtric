...
kubectl -n nonrtric delete deployment dmaap-mr message-generator oru-app sdnr-simulator
kubectl -n nonrtric delete svc dmaap-mr message-generator oru-app sdnr-simulator
