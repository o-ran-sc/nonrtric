...
import org.oran.pmlog.tasks.KafkaTopicListener.DataFromTopic;
...
public class InfluxStore {
    ...
    private Mono<String> storeInInflux(DataFromTopic data) {
