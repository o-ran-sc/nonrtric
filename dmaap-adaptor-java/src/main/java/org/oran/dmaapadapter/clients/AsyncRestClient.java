...
public class AsyncRestClient {
    ...
    public Mono<ResponseEntity<String>> postForEntity(String uri, @Nullable String body, MediaType contentType) {
    ...
    public Mono<String> post(String uri, @Nullable String body, MediaType contentType) {
