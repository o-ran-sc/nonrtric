...
@TestPropertySource(
    properties = {"server.ssl.key-store=./config/r-app-catalogue-keystore.jks"})
public class HttpsRequestTest {

    public static final String CLIENT_TRUSTSTORE = "client-truststore.jks";
    public static final String CLIENT_KEYSTORE = "client-keystore.jks";
    ...
    public void rest_OverPlainHttp_GetsExpectedResponse() throws Exception {
        ...
        ResponseEntity<String> responseEntity =
            template.getForEntity("http://localhost:" + httpPort + "/services", String.class);
    ...
    public void rest_WithTwoWaySSL_AuthenticatesAndGetsExpectedResponse() throws Exception {
        ...
        SSLContext sslContext = new SSLContextBuilder()
            .loadKeyMaterial(
                getClass().getClassLoader().getResource(CLIENT_KEYSTORE),
                keyStorePassword.toCharArray(),
                keyStorePassword.toCharArray())
            .loadTrustMaterial(
                getClass().getClassLoader().getResource(CLIENT_TRUSTSTORE),
                keyStorePassword.toCharArray(),
