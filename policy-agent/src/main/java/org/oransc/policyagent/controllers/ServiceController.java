...
public class ServiceController {
    ...
    public ResponseEntity<String> getServices(//
        @ApiParam(name = "name", required = false, value = "The name of the service") @RequestParam(
            name = "name",
    ...
    public ResponseEntity<String> deleteService(//
        @ApiParam(name = "name", required = true, value = "The name of the service") @RequestParam(
            name = "name",
