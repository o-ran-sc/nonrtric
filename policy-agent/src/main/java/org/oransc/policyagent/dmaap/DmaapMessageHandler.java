...
public class DmaapMessageHandler {
    ...
    private String policyAgentResponseTopic = "";
    ...
    public void handleDmaapMsg(String msg) {
        ...
        try {
            ...
            restClient.post(policyAgentResponseTopic,
    ...
    //Need to fix this
    public void init() {
        Properties dmaapPublisherConfig = applicationConfig.getDmaapConsumerConfig();
        String host = (String) dmaapPublisherConfig.get("ServiceName");
        policyAgentResponseTopic = dmaapPublisherConfig.getProperty("topic");
        System.out.println("policyAgentResponseTopic"+policyAgentResponseTopic);
