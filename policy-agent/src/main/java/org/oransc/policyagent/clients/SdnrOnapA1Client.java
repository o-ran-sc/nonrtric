...
public class SdnrOnapA1Client implements A1Client {
    ...
    public Mono<List<String>> getPolicyTypeIdentities() {
        ...
        return restClient
            .post_withAuthHeader("/A1-ADAPTER-API:getPolicyTypes", inputJsonString, A1_CONTROLLER_USERNAME,
    ...
    public Mono<List<String>> getPolicyIdentities(String policyTypeId) {
        ...
        return restClient
            .post_withAuthHeader("/A1-ADAPTER-API:getPolicyInstances", inputJsonString, A1_CONTROLLER_USERNAME,
                A1_CONTROLLER_PASSWORD) //
    ...
    public Mono<String> putPolicy(Policy policy) {
        ...
        return restClient.post_withAuthHeader("/A1-ADAPTER-API:createPolicyInstance", inputJsonString,
    ...
    public Mono<String> deletePolicy(String policyTypeId, String policyId) {
        ...
        return restClient.post_withAuthHeader("/A1-ADAPTER-API:deletePolicyInstance", inputJsonString,
            A1_CONTROLLER_USERNAME, A1_CONTROLLER_PASSWORD);
    }
