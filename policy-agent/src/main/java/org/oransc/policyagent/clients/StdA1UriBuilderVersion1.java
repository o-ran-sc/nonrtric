...
public class StdA1UriBuilderVersion1 implements A1UriBuilder {
    ...
    @Override
    public String putPolicyUri(Policy policy) {
        return policiesBaseUri() + policy.id();
    }

    @Override
    public String getPolicyIdsUri() {
        return baseUri() + "/policies";
    }

    @Override
    public String deleteUri(String policyId) {
        return policiesBaseUri() + policyId;
    }

    @Override
    public String policyStatusUri(String policyId) {
        return policiesBaseUri() + policyId + "/status";
    }

    private String baseUri() {
        final String urlPrefix = "/A1-P/v1";
        return ricConfig.baseUrl() + urlPrefix;
    }
