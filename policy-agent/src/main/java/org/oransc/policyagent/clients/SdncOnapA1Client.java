...
public class SdncOnapA1Client implements A1Client {
    ...
    private Flux<String> getPolicyTypeIds() {
        ...
        return restClient
            .postWithAuthHeader("/A1-ADAPTER-API:getPolicyTypes", inputJsonString, controllerConfig.userName(),
                controllerConfig.password()) //
    ...
    private Flux<String> getPolicyIdentitiesByType(String policyTypeId) {
        ...
        return restClient
            .postWithAuthHeader("/A1-ADAPTER-API:getPolicyInstances", inputJsonString, controllerConfig.userName(),
                controllerConfig.password()) //
