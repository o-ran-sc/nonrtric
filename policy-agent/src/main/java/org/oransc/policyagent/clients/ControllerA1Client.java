...
public class ControllerA1Client implements A1Client {
    ...
    public Mono<List<String>> getPolicyTypeIdentities() {
        ...
        return restClient
            .post("/A1-ADAPTER-API:getPolicyTypeIdentities", inputJsonString, A1_CONTROLLER_USERNAME,
    ...
    public Mono<List<String>> getPolicyIdentities() {
        ...
        return restClient
            .post("/A1-ADAPTER-API:getPolicyIdentities", inputJsonString, A1_CONTROLLER_USERNAME,
                A1_CONTROLLER_PASSWORD) //
    ...
    public Mono<String> getPolicyTypeSchema(String policyTypeId) {
        ...
        return restClient
            .post("/A1-ADAPTER-API:getPolicyType", inputJsonString, A1_CONTROLLER_USERNAME, A1_CONTROLLER_PASSWORD) //
    ...
    public Mono<String> putPolicy(Policy policy) {
        ...
        return restClient
            .post("/A1-ADAPTER-API:putPolicy", inputJsonString, A1_CONTROLLER_USERNAME, A1_CONTROLLER_PASSWORD) //
    ...
    public Mono<String> deletePolicy(String policyId) {
        ...
        return restClient.post("/A1-ADAPTER-API:deletePolicy", inputJsonString, A1_CONTROLLER_USERNAME,
            A1_CONTROLLER_PASSWORD);
    }
