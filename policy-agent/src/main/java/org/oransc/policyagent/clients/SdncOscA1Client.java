...
public class SdncOscA1Client implements A1Client {
    ...
    private Mono<String> post(String rpcName, String ricUrl, Optional<String> body) {
        ...
        return restClient.postWithAuthHeader(controllerUrl(rpcName), inputJsonString, this.controllerConfig.userName(),
            this.controllerConfig.password()).flatMap(this::extractResponseBody);
    }
