...
/**
 * A resource lock. The caller thread will be blocked util the lock
 * is granted.
 * Exclusive means that the caller takes exclusive wnership of the resurce.
 * Non exclusive lock means that several users can lock the resource
 * (for shared usage).
 */
public class Lock {
