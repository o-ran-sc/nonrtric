...
public class ApplicationConfigTest {
    ...
    public void addRicShouldNotifyAllObserversOfRicAdded() throws Exception {
        ...
        ConfigUpdate update = appConfigUnderTest.setConfiguration(Arrays.asList(RIC_CONFIG_1), null, null).blockFirst();
        assertEquals(ConfigUpdate.Type.ADDED, update.getType());
    ...
    public void changedRicShouldNotifyAllObserversOfRicChanged() throws Exception {
        ...
        assertEquals(ConfigUpdate.Type.CHANGED, update.getType());
    ...
    public void removedRicShouldNotifyAllObserversOfRicRemoved() {
        ...
        ConfigUpdate update = appConfigUnderTest.setConfiguration(Arrays.asList(ricConfig2), null, null).blockFirst();

        assertEquals(ConfigUpdate.Type.REMOVED, update.getType());
