...
public class ApplicationTest {
    ...
    private Policy addPolicy(String id, String typeName) throws ServiceException {
    ...
    public void getPolicy() throws Exception {
        ...
        Policy policy = addPolicy("id", "typeName");
        {
    ...
    @Test
    public void getPoliciesType() throws Exception {
