...
TC_ONELINE_DESCR="Create 1 policy with SDNC and without SDNC over agent REST"
...
# REKOVE THIS
#export POLICY_AGENT_IMAGE="o-ran-sc/nonrtric-policy-agent"
#export POLICY_AGENT_IMAGE_TAG="1.0.0-SNAPSHOT"
...
for TEST in $VARIANTS ; do
    ...
    prepare_consul_config_ext_agent      $TEST  ".ext.consul_config.json"
