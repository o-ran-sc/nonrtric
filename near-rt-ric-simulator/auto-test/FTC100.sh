...
for interface in $TESTED_VARIANTS ; do
    ...
    api_put_service 201 "rapp1" 1000 "$CR_PATH/callbacks/1"

    api_put_service 200 "rapp1" 2000 "$CR_PATH/callbacks/1"


    api_put_service 400 "rapp2" -1 "$CR_PATH/callbacks/2"

    api_put_service 400 "rapp2" "wrong" "$CR_PATH/callbacks/2"
    ...
    api_get_services 200 "rapp1" 2000 "$CR_PATH/callbacks/1"

    api_get_service_ids 200 "rapp1" "rapp2"


    api_put_service 201 "rapp3" 5000 "$CR_PATH/callbacks/3"
    ...
    api_get_services 404

    api_put_service 201 "rapp1" 50 "$CR_PATH/callbacks/1"
    ...
    echo -e $YELLOW"TR8"$EYELLOW
    api_get_ric 404 NOME
    ...
    api_put_service 201 "rapp10" 3600 "$CR_PATH/callbacks/1"
