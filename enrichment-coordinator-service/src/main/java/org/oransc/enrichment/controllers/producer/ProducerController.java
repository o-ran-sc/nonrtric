...
public class ProducerController {
    ...
    @ApiOperation(value = "Job definitions for an individual EI producer", notes = "Query EI jobs")
    @ApiResponses(
        value = { //
    ...
    @PutMapping(
        path = ProducerConsts.API_ROOT + "/eiproducers/{eiProducerId}",
        produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Definitions for an individual EI producer", notes = "Put EI producer")
    @ApiResponses(
        value = { //
