...
public class ProducerConsts {
    ...
    public static final String PRODUCER_API_NAME = "R1 Data producer (registration)";
    public static final String PRODUCER_API_DESCRIPTION = "API for data producers";

    public static final String PRODUCER_API_CALLBACKS_NAME = "R1 Data producer (callbacks)";
