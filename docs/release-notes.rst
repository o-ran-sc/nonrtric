...
|            |          |                  |                    |
+------------+----------+------------------+--------------------+
| 2021-12-13 | 2.3.3    | Henrik Andersson | E Release          |
|            |          |                  | Renamed and minor  |
|            |          |                  | improvements       |
+------------+----------+------------------+--------------------+
...
|            |          |                  | D Release                   |
+------------+----------+------------------+-----------------------------+
| 2021-12-14 | 1.1.0    | Henrik Andersson | Update to match ONAP Policy |
|            |          |                  | helm participant            |
+------------+----------+------------------+-----------------------------+
...
|            |          |                  |                 |
+------------+----------+------------------+-----------------+
| 2021-12-13 | 1.0.0    | Henrik Andersson | Initial version |
|            |          |                  | E Release       |
+------------+----------+------------------+-----------------+
...
|            |          |                  |                 |
+------------+----------+------------------+-----------------+
| 2021-12-14 | 1.0.0    | Henrik Andersson | Initial version |
|            |          |                  | E Release       |
+------------+----------+------------------+-----------------+
