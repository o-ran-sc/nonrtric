...
More details about the use case can be found on the O-RAN SC wiki: `RSAC <https://lf-o-ran-sc.atlassian.net/wiki/spaces/RICNR/pages/15075523/Control+Loops+for+O-RU+Fronthaul+Recovery+usecase+G+Release>`_ and `OAM <ttps://lf-o-ran-sc.atlassian.net/wiki/spaces/OAM/pages/14680350/Closed+loop+use+case>`_.
